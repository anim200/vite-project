...
export default function Parallax({ type }) {
  ...
  const titleText = type === "services" ? "What We Do?" : "What We Did?";

  return (
    <div className="parallax" ref={ref} style={{ background: gradient }}>
      <motion.h1 style={{ y: yText  }}>{titleText}</motion.h1>
